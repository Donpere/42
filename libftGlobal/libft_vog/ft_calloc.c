...
// need ft_bzero
// The line of code: if (nmemb!= t / size), verifies that by dividing 
// the result of the multiplication, we find the original values. 
// If not, so the value stored in t is incorrect, 
// due to a type limit violation.
